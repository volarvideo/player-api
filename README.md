...
| `setEmbedURL()` | string | Tell the iframe to change the url that should be used for the social icons.  Useful when the permalink of the embed page isn't immediately obvious to the iframe. |
